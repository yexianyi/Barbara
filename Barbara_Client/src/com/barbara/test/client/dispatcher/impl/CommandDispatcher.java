package com.barbara.test.client.dispatcher.impl;

import java.net.Socket;

import com.barbara.test.client.exception.UnRecognizedCommandException;
import com.barbara.test.client.handler.abs.BaseCommandHandler;
import com.barbara.test.client.handler.ext.AddBirdCommandHandler;
import com.barbara.test.client.handler.ext.AddSightingCommandHandler;
import com.barbara.test.client.handler.ext.ListBirdsCommandHandler;
import com.barbara.test.client.handler.ext.ListSightingsCommandHandler;
import com.barbara.test.client.handler.ext.QuitCommandHandler;
import com.barbara.test.client.handler.ext.RemoveBirdCommandHandler;
